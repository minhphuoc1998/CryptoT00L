...
{
    public partial class DESForm : DevExpress.XtraEditors.XtraUserControl
    {
        private static DESForm _instance;
        private DES des;

        public static DESForm Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new DESForm();
                return _instance;
            }
        }
        ...
        public void encryptFile(String inputFile, String outputFile, String key, String mode)
        {
            ...
            //des.IV = ASCIIEncoding.ASCII.GetBytes(key.Substring(0, 16));
            if (mode == "ECB")
